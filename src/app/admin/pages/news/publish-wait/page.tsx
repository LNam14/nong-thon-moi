...
import { getNewsApprove, getNewsList, getNewsPublishing } from "@/app/redux-store/news/slice";
import FormPublishing from "@/app/admin/components/form/FormPublishing";
import FormWFA from "@/app/admin/components/form/FormApprove";
interface newsItem {
    ID: number;
    TenDanhMuc: string;
    createBy: string;
