...
import { getNewsList, getNewsPublishing, getNewsRefuse } from "@/app/redux-store/news/slice";
import FormPublishing from "@/app/admin/components/form/FormPublishing";
import FormWFA from "@/app/admin/components/form/FormRefuse";
interface newsItem {
    ID: number;
    TenDanhMuc: string;
    createBy: string;
