...
import { Grid, Box, Button, TableContainer, Table, TableHead, TableRow, TableCell, Typography, TableBody, Pagination } from "@mui/material";
...
import { getNewsList, getNewsPublishing, getNewsRefuse, getNewsRemove } from "@/app/redux-store/news/slice";
import FormWFA from "@/app/admin/components/form/FormRemove";
interface newsItem {
    ID: number;
    TenDanhMuc: string;
    createBy: string;
